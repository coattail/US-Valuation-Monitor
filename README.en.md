...
- When verified public or licensed forward PE anchors exist, their covered interval is rebuilt from those anchors instead of reusing the previously published daily values, preventing an old source-basis error from becoming permanent.
